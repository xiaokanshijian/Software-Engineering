                  ...
                  <div style="padding: 15px">
                    ...
                    >
                       <div style="display: flex; flex: 1">
                        <dv-decoration-11 style="width：20px;height:60px;text-align:center;">天气数据</dv-decoration-11>
                       </div>
                       <div>
                       <img :src="require('@/assets/tianqi.jpg')" style="width: 450px; height: 250px;"  alt="天气数据">
                      </div>
                    </div>
