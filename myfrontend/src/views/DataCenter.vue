                ...
                <div class="aboveTwo">
                  ...
                  <dv-border-box-12>
                    <div style="padding: 5px">
                      ...
                      <div ref="thirdMain" style="width: 400px; height: 80px"></div>
                    </div>
                  </dv-border-box-12>
              ...
              <div class="below">
                ...
                <dv-border-box-9 :color="['#568aea']">
                  <div style="padding: 7px">
                    ...
                    <div ref="lastMain" style="width: 100%; height: 60px; margin-top: 25px"></div>
                  </div>
                </dv-border-box-9>
...
export default {
  ...
  async created() {
    const response = await axios.get(`myApp/dataCenter/`);
